...
`,ht=document.getElementById("modal-root"),pt=({car:t,onClose:n})=>{const{id:o,make:s,model:r,year:d,rentalPrice:u,address:p,type:a,accessories:f,mileage:O,img:T,fuelConsumption:M,engineSize:P,description:R,functionalities:B,rentalConditions:b}=t,D=p.split(",")[1],_=p.split(",")[2],C=(l=>{const g={},y=l.split(`
`)[0].split(" ");return g.conditionText=y.slice(0,2).join(" "),g.minAge=y[y.length-1],g})(b);z.useEffect(()=>{const l=g=>{g.code==="Escape"&&n()};return window.addEventListener("keydown",l),document.body.style.overflow="hidden",()=>{window.removeEventListener("keydown",l),document.body.style.overflow="visible"}},[n]);const A=l=>{l.target===l.currentTarget&&n()};return $.createPortal(e.jsx(tt,{onClick:A,children:e.jsxs(et,{children:[e.jsx(X,{style:nt,onClick:n}),e.jsx(ot,{src:T,alt:s,loading:"lazy",width:"469",height:"314"}),e.jsxs(it,{children:[e.jsx(st,{children:e.jsxs(rt,{children:[s," ",e.jsxs(lt,{children:[r,", "]}),d]})}),e.jsxs(j,{children:[e.jsx(c,{children:D}),e.jsx(c,{children:_}),e.jsxs(c,{children:["Id: ",o]}),e.jsxs(c,{children:["Year: ",d]}),e.jsxs(c,{children:["Type: ",a]})]}),e.jsxs(j,{children:[e.jsxs(c,{children:["Fuel Consumption: ",M]}),e.jsxs(c,{children:["Engine Size: ",P]})]}),e.jsx(at,{children:R}),e.jsx(L,{children:"Accessories and functionalities:"}),e.jsx(j,{children:f.map(l=>e.jsx(c,{children:l},l))}),e.jsx(j,{children:B.map(l=>e.jsx(c,{children:l},l))}),e.jsx(L,{children:"Rental Conditions:"}),e.jsxs(ct,{children:[e.jsx(m,{children:e.jsxs("p",{children:[C.conditionText,e.jsxs(v,{children:[" ",C.minAge]})]})}),e.jsx(m,{children:b.split(`
